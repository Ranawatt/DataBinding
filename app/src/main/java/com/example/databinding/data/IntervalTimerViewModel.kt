...
import com.example.databinding.util.ObservableViewModel
import com.example.databinding.util.cleanSecondsString
import java.util.*
 ...
 */
class IntervalTimerViewModel(private val timer: DefaultTimer) : ObservableViewModel() {
